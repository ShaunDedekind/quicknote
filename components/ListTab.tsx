  ...
  return (
    <div className="absolute inset-0 overflow-y-auto">
      ...
      <div className="px-5 pt-10 pb-5">
        <h2 className="text-xl font-bold text-neutral-100">Notes</h2>
        {notes.length > 0 && (
      ...
      {notes.length === 0 ? (
        ...
        <div className="flex flex-col items-center justify-center gap-3 px-8 pb-20 pt-10 text-center">
          <div className="flex h-16 w-16 items-center justify-center rounded-full bg-neutral-900">
            <svg width="22" height="22" viewBox="0 0 24 24" fill="none" stroke="#404040" strokeWidth="1.75" strokeLinecap="round" strokeLinejoin="round">
          ...
          <p className="max-w-[180px] text-xs leading-relaxed text-neutral-700">
